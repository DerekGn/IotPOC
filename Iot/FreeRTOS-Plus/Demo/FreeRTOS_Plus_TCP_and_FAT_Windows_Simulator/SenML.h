...
#define SENML_MAX_NAME			20		// The max lenght of name
#define SENML_MAX_UNIT			10		// The max lenght of unit
#define SENML_MAX_BASENAME		20		// The max lenght of base name
#define SENML_MAX_BASEUNIT		10		// The max lenght of base unit
...
typedef struct SenMLBaseInfo
{
	...
	char cBaseUnit[SENML_MAX_BASEUNIT];		// Base unit that is assumed for all entries, unless otherwise indicated.
